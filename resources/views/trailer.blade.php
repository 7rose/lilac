...
<div class="modal-container">
    ...
    <div class="content">
        ...
        <p>
            1. 以平台公布信息为准。<br>
            2. 牧云可能会根据需要调整相关信息，并再不另行通知。<br>
            3. 牧云可能会应上级主管部门要求调整相关信息，且不再另行通知。<br>
            4. 因牧云原因而造成的信息调整，对用户千万损害的，赔偿金额上限为用户受影响购票金额。<br>
        </p>
        <h5>票的使用</h5>
        <p>
            1. 门票为电子票，需本人配合微信使用；牧云不另提供纸质票；每场次每位用户限购2张。<br>
            2. 平台为唯一的发票通道；任何专用、额外付费抢票等均为骗局，用户应悉知。<br>
            3. 本电子票为入场的唯一身份凭证，因任何原因不能出示此票的，牧云有权拒绝该用户入场。<br>
            4. 为保障全体用户权益，除特殊原因牧云不提供退换票服务，请用户酌情购买。<br>
            5. 牧云为到场用户赠送的礼品为免费赠予，用户自由选择。牧云不就此提供任何质量、和使用保证，也不提供退换服务。<br>
            6. 用户购票后，将在统一的时间（以平台公布为准）抽出入场次序，牧云将使用公开抽取，并实时在系统登记，确保公平性。<br>
            顺序抽取为一次性，且无法改变。公开抽取为确定入场次序唯一的渠道，任何额外付费排序的均为骗局，用户应悉知。<br>
        </p>
        <h5>展会现场</h5>
        <p>
            1. 根据防疫安全要求，现场会设立隔离测温区，届时请根据相关规则以此排队，全程需佩戴口罩参加。<br>
